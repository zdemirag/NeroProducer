...
if isData:
   ...
   fileList = [
       'file://eos/cms/store/mc/RunIIFall15MiniAODv2/TTbarDMJets_pseudoscalar_Mchi-1_Mphi-100_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/MINIAODSIM/PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1/20000/0A4E9031-7CB9-E511-8ABE-02163E00EA21.root'       
...
if options.isData:
    jerString = cms.string('sqlite:jer/'+era+'_DATA.db')
    jerTags   = era+"_DATA"
else:
    jerString = cms.string('sqlite:jer/'+era+'_MC.db')
    jerTags   = era+"_MC"
...
process.jer = cms.ESSource("PoolDBESSource",
        ...
        toGet = cms.VPSet(
            ...
            cms.PSet(
                ...
                tag    = cms.string('JR_'+jerTags+'_PtResolution_AK4PFchs'),
                label  = cms.untracked.string('AK4PFchs_pt')
                ),
            # Phi
            cms.PSet(
                record = cms.string('JetResolutionRcd'),
                tag    = cms.string('JR_'+jerTags+'_PhiResolution_AK4PFchs'),
                label  = cms.untracked.string('AK4PFchs_phi')
                ),        
            # Scale factors
            cms.PSet(
                record = cms.string('JetResolutionScaleFactorRcd'),
                tag    = cms.string('JR_'+jerTags+'_SF_AK4PFchs'),
